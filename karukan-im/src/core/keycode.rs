...
impl Keysym {
    ...
    pub const KEY_D: Keysym = Keysym(0x0064); // lowercase 'd'
    pub const KEY_D_UPPER: Keysym = Keysym(0x0044); // uppercase 'D'
    ...
    pub const KEY_H: Keysym = Keysym(0x0068); // lowercase 'h'
